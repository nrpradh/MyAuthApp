  ...
  return (
    <View style={styles.authContainer}>
      ...
      <View style={styles.buttonContainer}>
        <Button title={isLogin ? 'Sign In' : 'Sign Up'} onPress={handleAuthentication} color="#202020" />
      </View>
...
export default App = () => {
  ...
  const handleAuthentication = async () => {
    try {
      ...
      if (error.code === 'IncorrectPasswordException') {
        // Alert for incorrect password
        Alert.alert(
          'Authentication Failed',
          'The password you entered is incorrect. Please try again.',
          [{ text: 'OK', onPress: () => console.log('Incorrect Password Alert Closed') }],
          { cancelable: false }
        );
      } else {
        // Generic error alert
        Alert.alert(
          ...
          [{ text: 'OK', onPress: () => console.log('Authentication Error Alert Closed') }],
          { cancelable: false }
        );
      }
    }
